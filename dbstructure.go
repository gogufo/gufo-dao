...
type Users struct {
	...
	Status        int    `gorm:"column:status;type:bool;DEFAULT 'false'"`
	Completed     int    `gorm:"column:completed;type:bool;DEFAULT 'false'"`
	IsAdmin       int    `gorm:"column:is_admin;type:bool;DEFAULT 'false'"`
	Readonly      int    `gorm:"column:readonly;type:bool;DEFAULT 'false'"`
}
...
type APITokens struct {
	...
	Status     int    `gorm:"column:status;type:bool;DEFAULT 'true'"`    // if true - active, if false - deactivated
	IsAdmin    int    `gorm:"column:is_admin;type:bool;DEFAULT 'false'"` //only if generated by admin
	Readonly   int    `gorm:"column:readonly;type:bool;DEFAULT 'false'"`
