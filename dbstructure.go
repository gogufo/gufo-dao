...
type APITokens struct {
	...
	Created    int    `gorm:"column:created;type:int(11);DEFAULT '0'"`
	Expiration int    `gorm:"column:expiration;type:int(11);DEFAULT '0'"`  //if 0 - no expiration time
	Status     int    `gorm:"column:status;type:double;DEFAULT 'true'"`    // if true - active, if false - deactivated
	IsAdmin    int    `gorm:"column:is_admin;type:double;DEFAULT 'false'"` //only if generated by admin
	Readonly   int    `gorm:"column:readonly;type:double;DEFAULT 'false'"`
